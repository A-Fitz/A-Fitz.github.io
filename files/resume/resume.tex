...
\begin{itemize}[leftmargin=*]
	...
	\item[] \skill{Frameworks}{Angular 2+, AngularJS, Spring, .NET}
	\item[] \skill{Databases}{SQL Server, PostgreSQL}
	\item[] \skill{Software}{Microsoft Office, Jira, BitBucket, Confluence, Bamboo, GitHub, GitLab, ServiceNow, WebSphere, AWS, SonarQube, Burp Suite}
...
\begin{itemize}[leftmargin=*]
	...
	\item[]
	      ...
	      {\\I served as an Election Judge in Kane County, Illinois during the 11/2022 and 05/2023 elections. I also served as a Zone Manager for six sites during the 03/2024 election. }
	\item[]
	      \organization
